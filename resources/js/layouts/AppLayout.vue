...
<template>
    ...
    <PrivacyPolicyBanner :current-version="privacyPolicyVersion" :change-date="privacyPolicyChangeDate"
                        ...
                        <p class="text-muted-foreground text-sm">
                            ...
                            <span v-if="supportEmail">Please be patient and send any and all feedback (feature requests,
                                ...
                                <a class="text-primary font-medium hover:underline" :href="`mailto:${supportEmail}`"> {{
                                    supportEmail }} </a>.</span>
                            <span v-if="roadmapUrl">
                                View the roadmap
                                <a class="text-primary font-medium hover:underline" target="_blank" :href="roadmapUrl">
                                    here </a>.
                            </span>
                        </p>
                    </div>
